...
function show_success(msg){
	...
	$('#error').slideDown('slow');
	  ...
	  <body background="backgrounds/24.png">
	    ...
	    <div class="container">
	      <form class="form-signin" action="#" onsubmit="return validate_form(this)" enctype="multipart/form-data" method="post">
...
if(isset($_POST['submit']))
{
	...
	if($passwd==$repasswd)
	{
	mysql_query("UPDATE b1_details SET bpwd='$passwd'");
	echo "<script>show_success('Messg : Successfully Changed Your  Password');</script>";
	}
	else
	{
